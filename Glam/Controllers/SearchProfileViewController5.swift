...
class SearchProfileViewController5: UIViewController {
    @IBOutlet weak var textField: UILabel!
    @IBOutlet weak var emailField: UILabel!
    @IBOutlet weak var profilePic: UIImageView!
    
    var text = NearMeCustomer.GlobalVariable.currentItem
    ...
    @IBAction func back(_ sender: Any) {
        ...
        let SearchCategory = storyBoard.instantiateViewController(withIdentifier: "nearMeCustomerNav") as! UINavigationController
