...
class SearchProfileViewController4: UIViewController {
    @IBOutlet weak var textField: UILabel!
    @IBOutlet weak var emailField: UILabel!
    @IBOutlet weak var profilePic: UIImageView!
    
    var text = BusinessCategory.GlobalVariable.currentItem
    ...
    @IBAction func back(_ sender: Any) {
        ...
        let SearchCategory = storyBoard.instantiateViewController(withIdentifier: "businesscategorynav") as! UINavigationController
