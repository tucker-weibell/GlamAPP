...
class CustomerCategory: UITableViewController {
    var users: [String] = []
    var address: [String] = []
    var key = HomeCustomerViewController.GlobalVarible.buttonClicked
    ...
    @IBAction func search(_ sender: Any) {
        performSegue(withIdentifier: "toTheSearch", sender: self)
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let SearchProfileViewController = storyBoard.instantiateViewController(withIdentifier: "SearchProfileViewController3")
        self.present(SearchProfileViewController, animated: true, completion: nil)
    }
    
}

extension CustomerCategory: CLLocationManagerDelegate {
