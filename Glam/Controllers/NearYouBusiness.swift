...
class NearYouBusiness: UITableViewController {
    var users: [String] = []
    var address: [String] = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "nearyoubusinesscell", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let SearchProfileViewController = storyBoard.instantiateViewController(withIdentifier: "SearchViewController6")
        self.present(SearchProfileViewController, animated: true, completion: nil)
    }
    
}

extension NearYouBusiness: CLLocationManagerDelegate {
